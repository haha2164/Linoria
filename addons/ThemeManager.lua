...
local HttpService = cloneref(game.FindService(game, 'HttpService'))

local ThemeManager = {} do
	ThemeManager.Folder = 'LinoriaSettings'
	ThemeManager.Library = nil
	ThemeManager.BuiltInThemes = {
		['Default'] = { 1, HttpService:JSONDecode('{"FontColor":"919191","MainColor":"101010","AccentColor":"ca6e40","BackgroundColor":"111111","OutlineColor":"2d2d2d"}') },
